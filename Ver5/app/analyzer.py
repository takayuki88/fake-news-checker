...
PRIMARY_REVIEW_RISK_WEIGHT = 0.60
PRIMARY_REVIEW_CONFIDENCE_WEIGHT = 0.50
PRIMARY_REVIEW_RISK_DELTA_CAP = 20
PRIMARY_REVIEW_CONFIDENCE_DELTA_CAP = 16
    ...
    if isinstance(primary_review_risk_score, int) and isinstance(heuristic_risk_score, int):
        steps.append(
            ScoreCalculationStep(
                ...
                note="Ver5 では Gemini の一次判定案を Ver3 より強く混ぜて内部リスク点を補正します。",
            )
        )
